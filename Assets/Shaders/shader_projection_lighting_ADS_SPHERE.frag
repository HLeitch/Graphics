...
{	//LIGHTING
	...
	//vec4 textureColour = texture(aTex, textureCoordinate)*vec4((step(0.6, fragmentPosition.y+(sin(time/500.0)))*vec3(1.0,1.0,1.0)),1.0);


	vec4 textureColour = mix(texture(aTex, textureCoordinate),vec4(1.0,0.0,0.0,0.0),sin(time/500.0));
