...
{	//LIGHTING
	...
	//height based colour
	vec4 textureColour = texture(aTex, textureCoordinate)+(step(0.0+cnoise(uv.xy*3),-pos.y)*vec4(0.0,0.3,0.9,1.0));
	//vec4 textureColour = texture(aTex, textureCoordinate)+(step(0.0,-pos.y)*vec4(0.0,0.3,0.9,1.0));
