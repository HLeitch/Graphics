...
void main()
{
	...
	vec3 pos = Position;
	pos.y = 0.25 * cnoise(vec2(pos.x,pos.z));
	pos.y += 0.25 *cnoise(vec2(pos.x,pos.z)*2)*0.5;
	pos.y += 0.25 *cnoise(vec2(pos.x,pos.z)*4)*0.25;
	pos.y += 0.25 *cnoise(vec2(pos.x,pos.z)*8)*0.125;
	pos.y += 0.25 *cnoise(vec2(pos.x,pos.z)*16)*0.0625;
	pos.y += 0.25 *cnoise(vec2(pos.x,pos.z)*32)*0.03125;
